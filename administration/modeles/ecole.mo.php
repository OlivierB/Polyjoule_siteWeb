...
function affichageEcoles() {
	...
	while ($ecole=mysql_fetch_array($req)) {
		...
		echo "<a style='text-decoration:none;color:green;' href='index.php?page=ecole&action=2&idEcole=".$ecole[0]."'>Modifier</a> - ";
		echo "<a style='text-decoration:none;color:red;' href='index.php?page=ecole&action=3&idEcole=".$ecole[0]."'>Supprimer</a>";
		echo "</td>";
		echo "</tr>";
	}
	mysql_free_result($req);
